...
#     cell_info_1 = {'num_mode':num_mode, 'input_size': input_size,'output_size': output_size, 'kernel_size': 1, 'sharing_rate':sharing_rate}
#     cell_info_2 = {'num_mode': num_mode, 'input_size': restricted_size, 'output_size': output_size, 'kernel_size': 1, 'sharing_rate': sharing_rate}
...
if __name__ == "__main__":
    ...
    sharing_rate = 0
    shared_size = round(sharing_rate * output_size)
    cell_info_1 = {'input_size': input_size,'output_size': output_size, 'sharing_rate': sharing_rate, 'num_mode':num_mode}
    cell_info_2 = {'input_size': output_size, 'output_size': output_size, 'sharing_rate': sharing_rate, 'num_mode': num_mode}
